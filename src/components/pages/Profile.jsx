                  ...
                  <div class="card-body">
                    <div class="d-flex flex-column align-items-center text-center">
                      ...
                      <div class="mt-3">
                        ...
                        <div className="g">
                          <a href="https://www.instagram.com/premium_dezinfeksiya_xizmati?igsh=ejhzZXRscGl4bG1h"><button class="btn btn-primary" style={{ fontSize: '14px' }}>Подписатся наш Инстаграмм</button></a>
                          <a href="https://Premium_dez" ><button class="btn btn-outline-primary" style={{ fontSize: '15px' }}>Написать с телеграмм</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card mt-3">
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                      ...
                      <a href="" class="text-secondary">http://premium-dez.uz</a>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                      <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-instagram mr-2 icon-inline text-danger"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>Инстаграм</h6>
                      <a href="https://www.instagram.com/premium_dezinfeksiya_xizmati?igsh=ejhzZXRscGl4bG1h" class="text-secondary">Premium-dez</a>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
